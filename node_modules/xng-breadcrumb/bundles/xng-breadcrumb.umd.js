(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('xng-breadcrumb', ['exports', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/router', '@angular/core'], factory) :
    (factory((global['xng-breadcrumb'] = {}),global.rxjs,global.rxjs.operators,global.ng.common,global.ng.router,global.ng.core));
}(this, (function (exports,rxjs,operators,common,i1,i0) { 'use strict';
         ...
         */
            function (breadcrumb) {
                ...
                if (breadcrumbItemIndex > -1) {
                     ...
                     * @return {?}
                     */function (item) { return !item.skip; }));
                    this.breadcrumbs.next(__spread(breacrumbsToShow));
                }
